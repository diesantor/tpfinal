    ...
    <form action="tickets_Insert.php" method="post">
        <div class="container">
            ...
            <div class="row mb-3">
                ...
                <div class="col-4">
                    <input type="text" name="my_name" id="nombre" class="form-control" placeholder="Ingresar Nombre." >
                </div>
            
            <!--Ingresar Apellido-->
                <div class="col-4">
                    <input type="text" name="my_lastname" id="apellido" class="form-control" placeholder="Ingresar Apellido." >
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    <input type="email" name="my_email" id="correo" class="form-control"  placeholder="Ingresar correo electrónico." >
                </div>
                <div class="col-2"></div>
            </div>
            ...
            <div class="row mb-4 mt-4">
                ...
                <div class="col-4">
                    <input  type="text" name="my_quantity" id="cantidad" class="form-control" placeholder="Ingresar cantidad de tickets." >
                </div>
                ...
                <div class="col-4">
                    <div class="input-group">
                            ...
                            <select name="my_category" id="categorias"  class="form-control">
